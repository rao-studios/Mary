...
struct ThreadsRetrievalView: View {
    ...
    private func turnCard(_ row: ThreadRetrievalTurnRow) -> some View {
    ...
    private func header(_ row: ThreadRetrievalTurnRow, isOpen: Bool) -> some View {
    ...
    @ViewBuilder
    private func detail(_ row: ThreadRetrievalTurnRow) -> some View {
    ...
    private func planSection(_ plan: ThreadMemoryPlanRow) -> some View {
        VStack(alignment: .leading, spacing: 2) {
            SectionLabel("Plan")
    ...
    private func requestSection(_ request: ThreadRetrievalRequestRow) -> some View {
        VStack(alignment: .leading, spacing: 2) {
    ...
    private func groupTag(_ group: ThreadScopeGroupTag) -> some View {
        HStack(spacing: 3) {
    ...
    private func contributionSection(_ contribution: SewnContributionTrace) -> some View {
        VStack(alignment: .leading, spacing: .layer2) {
    ...
    private func ownerRow(_ owner: SewnContributionTrace.OwnerTrace) -> some View {
        VStack(alignment: .leading, spacing: 2) {
            HStack(spacing: .layer2) {
