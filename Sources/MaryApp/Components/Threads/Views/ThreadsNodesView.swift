//
//  ThreadsNodesView.swift
//  Mary
//
//  WHAT: Fleet as Sewn sees it, disk as it is — independent sections/authorities.
//

import SwiftUI

struct ThreadsNodesView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: .layer3) {
            ...
            if let header = vm.fleetHeader {
                ...
                Text("Reaching Sewn for the fleet…")
                    .font(.marySans(11))
    ...
    private func fleetCard(_ header: ThreadFleetHeader) -> some View {
        MaryCard {
            VStack(alignment: .leading, spacing: .layer2) {
                if header.enabled {
                    ...
                    // Sewn's honest "no fleet" — distinct from unreachable.
                    Text("No thread nodes are registered with the mothership.")
                        .font(.marySans(11))
    ...
    private func nodeCard(_ row: ThreadNodeRow) -> some View {
    ...
    private func diskSummaryCard(_ summary: ThreadDiskSummary) -> some View {
        MaryCard {
            VStack(alignment: .leading, spacing: .layer2) {
                FlowLayout(spacing: .layer4, lineSpacing: .layer2) {
    ...
    private func diskRow(_ row: ThreadDiskRow) -> some View {
