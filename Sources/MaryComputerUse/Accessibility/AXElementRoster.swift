...
//        Accessibility/ imports nothing from Sight/ or Hands/. Identity and
//        kind attach later, one way, in MaryPlugin's AmbientSurfaceBridge.
//        Windows grouped, then front-to-back.
...
public enum AXElementRoster {
    ...
    public static let minimumInteractiveSide: CGFloat = 8
