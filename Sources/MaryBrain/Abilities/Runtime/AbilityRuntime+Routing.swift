...
extension AbilityRuntime {
    ...
    public func beginTurn() {
        ...
        rosterArbitrationCache.withLock { $0 = nil }
        ...
        // WHATEVER THE ADAPTERS KEEP FOR ONE TURN, cleared by them. This named
        // one of them — the browser's search memo — in the generic reset.
        for adapter in adapters { adapter.beginTurn() }
