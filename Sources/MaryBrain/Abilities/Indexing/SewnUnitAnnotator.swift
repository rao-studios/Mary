//
//  SewnUnitAnnotator.swift
//  MaryBrain
//
//  WHAT: Hosted unit annotator over Sewn `/v1/complete`.
...
public struct SewnUnitAnnotator: UnitAnnotating {
    ...
    public func annotationAttempt(
        ...
        guard await complete.isReady() else {
            Self.log.debug("annotation skipped: sewn not ready")
            return .sewnUnavailable
        }
