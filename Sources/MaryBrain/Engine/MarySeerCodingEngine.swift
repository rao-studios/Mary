...
public actor MarySeerCodingEngine: CodingAgentBackend {
    ...
    public func unpreparedSummary() async -> String {
        "The coding agent is not ready. Choose Hosted under Coding Agent in Settings, sign in to Seer, and keep Chat through Seer on."
    }
