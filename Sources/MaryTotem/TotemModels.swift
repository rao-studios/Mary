...
/// One document going into the totem. Empty `entities` + `tags` means Totem
...
public struct DepositItem: Sendable, Equatable {
    ...
    public var entities: [TotemEntityIn]
    public var relationships: [TotemRelationIn]
    ...
    public init(
        ...
        metadata: Data = Data(),
        entities: [TotemEntityIn] = [],
        relationships: [TotemRelationIn] = []
    ) {
...
public struct PartitionHit: Sendable, Equatable {
    ...
    public init(
        totemID: String, partitionID: String, documentID: String,
...
/// Library metadata for one document. Totem has no content-by-id fetch —
