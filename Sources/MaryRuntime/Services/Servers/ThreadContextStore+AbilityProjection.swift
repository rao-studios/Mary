//
//  ThreadContextStore+AbilityProjection.swift
//  MaryRuntime
//
//  WHAT: Ability projection deposits on ThreadContextStore.
//  IN:   AbilityThreadProjectionPlan
...
extension ThreadContextStore {
    ...
    package static func durableProjections(
        in plan: AbilityThreadProjectionPlan,
        succeeded: Bool
        ...
        for destination in Self.projectionDestinations(
            ...
            let item = DepositItem(
                ...
                tags: [
                    ...
                    "thread:\(destination.lane.rawValue)",
                ],
            ...
            do {
                ...
                // Fire-and-forget: a missing Thread is a Servers-sheet concern.
                continue
            }
        }
    }
