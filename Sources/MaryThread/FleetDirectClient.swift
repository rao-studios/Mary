...
public actor FleetDirectClient {
    ...
    public func listAdapters(threadID: String) async throws -> [FleetLoRASlot] {
    ...
    public func adapterStatus(threadID: String, abilityID: String) async throws -> FleetLoRASlot {
    ...
    /// Empty `pairs` is the production path: Fleet ExportCorpus from Thread
